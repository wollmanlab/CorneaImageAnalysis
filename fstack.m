...
filtersize = checkparam('logsize', 13, varargin);
...
logstd = checkparam('logstd', 2,varargin);
dilatesize = checkparam('dilatesize', 31,varargin);
blendsize = checkparam('blendsize', 85,varargin);
blendstd = checkparam('blendstd', 14,varargin);
logthreshold = checkparam('logthreshold', 0,varargin);
