...
if plotX
    ...
    if inOneFigure
        subplot(plotX+plotY+plotZ+plotA+plotAS,1,1)
        hold on
    end
...
if plotY
    ...
    %if all figures will be in the same window, specify subplot
    if inOneFigure
        subplot(plotX+plotY+plotZ+plotA+plotAS,1,plotX+1)
        hold on
    end
...
if plotZ
    ...
    %if all figures will be in the same window, specify subplot
    if inOneFigure
        subplot(plotX+plotY+plotZ+plotA+plotAS,1,plotX+plotY+1)
        hold on
    end

    %extract y-coordinates from input
    yCoordSequence = tracksCoordAmpCG(:,3:8:end);
...
if plotA
    ...
    %if all figures will be in the same window, specify subplot
    if inOneFigure
        subplot(plotX+plotY+plotA+plotZ+plotAS,1,plotX+plotY+plotZ+1)
        hold on
    end
